...
function Category({ setCategory }: IProps) {
  ...
  return (
    ...
    >
      ...
      {/* popup */}
      {toggle && (
        <div className="absolute top-14 md:left-full md:-translate-x-6 md:top-8 w-60 h-44 rounded-sm text-left divide-y dark:divide-zinc-500 bg-white dark:bg-[#1b1b1f] shadow-lg z-20 flex flex-col justify-between">
          <p
            onClick={() => setCategory("")}
